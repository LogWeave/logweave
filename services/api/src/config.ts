...
export function loadConfig(): Config {
  return withReconcileCoupling.parse({
    ...
    recoveryEnabled: process.env.LOGWEAVE_RECOVERY_ENABLED || undefined,
    recoveryIntervalMs: process.env.LOGWEAVE_RECOVERY_INTERVAL_MS,
    archiveReconcileEnabled: process.env.LOGWEAVE_ARCHIVE_RECONCILE_ENABLED || undefined,
    archiveReconcileIntervalMs: process.env.LOGWEAVE_ARCHIVE_RECONCILE_INTERVAL_MS,
    archiveCompactionEnabled: process.env.LOGWEAVE_ARCHIVE_COMPACTION_ENABLED || undefined,
    ...
    retentionEnabled: process.env.LOGWEAVE_RETENTION_ENABLED || undefined,
